 ...
 */
public class GuideScreen1 implements Screen{
    ...
    public GuideScreen1(RhythmGame rhythmGame) {
    ...
    public void show() {
        ...
        ok.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ((Game) Gdx.app.getApplicationListener()).setScreen(new GuideScreen2(rhythmGame));
            }
        });
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(Assets.guide2, 0, 0, width, height);
        batch.end();
        stage.act();
        stage.draw();
    }
